...
<body>
<header class="topbar">
    <a class="brand" href="index.php"><span>LP</span><span class="brand-copy">Laguerta Picklebook<small>COURT RESERVATIONS</small></span></a>
    <nav class="top-actions" aria-label="Primary navigation">
        <?php if (($_GET['admin_view'] ?? '') === '1'): ?><a class="admin-back-button" href="admin-dashboard.php">← Back to Booking Results</a><?php endif; ?>
    ...
    <section class="workspace">
        <article class="panel form-panel" id="booking-form">
            <div class="panel-heading">
                ...
                <?php if ($editing): ?><a class="text-link" href="index.php">Cancel edit</a><?php endif; ?>
            </div>
        ...
        <article class="panel records-panel" id="reservations">
            <div class="panel-heading records-heading">
                ...
                <form method="get" class="search-form">
                    ...
                    <?php if ($keyword !== ''): ?><a href="index.php">Clear</a><?php endif; ?>
                </form>
            </div>
