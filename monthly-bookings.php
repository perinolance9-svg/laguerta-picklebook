...
<aside class="admin-sidebar"><a class="brand admin-brand" href="admin-dashboard.php"><span>LP</span><span class="brand-copy">Laguerta Picklebook<small>ADMIN</small></span></a><nav><a href="admin-dashboard.php">Booking results</a><a href="personal-gcash-admin.php">Verify payments</a><a href="completed-bookings.php">Completed bookings</a><a class="active" href="monthly-bookings.php">Monthly bookings</a><a href="admin-crud.php">Full CRUD system</a><a href="logout.php">Sign out</a></nav></aside>
